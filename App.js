...
export default function MyTabs() {
  ...
  return (
    <NavigationContainer>
      ...
      <Tab.Screen name="Pet" component={HomeScreen} options={{
       tabBarStyle:{paddingBottom:5, height:60},
      tabBarLabel: 'Pet',
      headerShown: false,
      tabBarActiveBackgroundColor: '#eee9ff',
      tabBarActiveTintColor: '#784498',
      tabBarLabelStyle: {fontSize:15, fontWeight: 'bold', paddingBottom:0},
 ...
 function HomeScreen() {
  ...
  const feed = () => { 
   ...
   const handleCamera = () => { 
    bool2 = !bool2;
    console.log("feed");
    firestore.collection("feeder").doc("feed").set({"camera":bool}, {merge:true});
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={{borderRadius:10,backgroundColor:'#cfb7ec',padding:20, shadowColor: '#470000',
        shadowOffset: {width: 0, height: 1},
        shadowOpacity: 0.7,
        marginBottom: 25,
        elevation: 20, borderColor: '#784498', borderWidth:1}} onPress={feed}>
      ...
      style={{borderRadius:10,backgroundColor:'#cfb7ec',padding:20, shadowColor: '#470000',
        shadowOffset: {width: 0, height: 1},
        shadowOpacity: 0.7,
        elevation: 20, borderColor: '#784498', borderWidth:1}} >
